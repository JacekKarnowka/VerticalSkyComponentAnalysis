...
app = dash.Dash('VSC-analysis', external_stylesheets=[dbc.themes.BOOTSTRAP])
server = app.server
...
def get_a_list(filenames):
    open_zip(r'.\Project\uploaded_folder\Data.zip')
    ...
    global all_options
    global def_option
    main_project_name = os.listdir(r'.\Data')

    project_number = str(main_project_name[0]).split('-')[1]

    img_base_path = r'.\Data\{}\Results'.format(main_project_name[0])
    path_all = r'.\Data\{}\{}-3d-VSC-APSH-template_Waldram\Reports'.format(main_project_name[0], project_number)
